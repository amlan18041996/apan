      ...
      <div class="card p-8">
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div>
            ...
            <input id="password" v-model="form.password" type="password" class="input-field" :class="{ 'border-red-500 focus:border-red-500 focus:ring-red-500': errors.password }" placeholder="Enter your password" @input="clearFieldError('password')" />
          ...
          <div class="flex items-center justify-between">
            ...
            <NuxtLink to="/auth/forgot-password" class="text-sm font-medium text-primary-600 hover:text-primary-700">Forgot password?</NuxtLink>
          </div>
        ...
        <p class="mt-8 text-center text-sm text-text-muted">
          ...
          <NuxtLink to="/auth/register" class="font-medium text-primary-600 hover:text-primary-700">Create one</NuxtLink>
        </p>
      </div>
    </div>
  </div>
