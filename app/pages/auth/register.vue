      ...
      <div class="card p-8">
        ...
        <form class="space-y-5" @submit.prevent="handleRegister">
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label for="firstName" class="mb-1.5 block text-sm font-medium text-text"
                >First name</label
              >
              <input
                id="firstName"
            ...
            <div>
              <label for="lastName" class="mb-1.5 block text-sm font-medium text-text"
                >Last name</label
              >
              <input
                id="lastName"
          ...
          <div>
            <label for="confirmPassword" class="mb-1.5 block text-sm font-medium text-text"
            ...
            <input
              ...
              class="input-field"
              :class="{
                'border-red-500 focus:border-red-500 focus:ring-red-500': errors.confirmPassword,
              }"
